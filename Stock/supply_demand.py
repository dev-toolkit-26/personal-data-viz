...
# 출고 가능 최소 잔여 유통기한 (제품 규격 기준의 하한선).
# ※ 운영 판정의 기준은 index.html의 STOCK_SHELF_* 이다. 그쪽은 OFF를 채널별로 나눠
#   (CVS·HYPER·SM 210일 / C&C·ALSM·기타 180일) 잔여 180~209일을 '6개월 채널 전용'으로
#   따로 잡는다. 이 스크립트는 하한선(180/90)만 쓰는 단순 점검용이라 값이 더 느슨하게 나온다.
